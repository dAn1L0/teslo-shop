...
export const AddressForm = ({ countries, userDbAddress = {} }: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2 sm:px-10' autoComplete="off">
      <div className='flex flex-col mb-2'>
        <span>Nombres</span>
        <input type='text' className="px-3 py-2 border bg-gray-300 rounded mb-2"
      ...
      <div className='flex flex-col mb-2'>
        <span>País</span>
        <select className="px-3 py-2 border bg-gray-300 rounded mb-2" {...register("country", { required: true })}>
